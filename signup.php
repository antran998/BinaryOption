...
<body onload="showSubmit();">
	<?php
		...
		$randomID = rand(1111,9999);
		//$randomID = 164654; match
		$query = "BEGIN :tem := SEARCH_ID(:randomID); END;";
		$statement = oci_parse($conn,$query);

		oci_bind_by_name($statement, ':randomID', $randomID);
	...
	<div id="avatar"><span class="centerID"><?php echo $randomID;?></span></div>
	<div id="form">
		<form action="test/signupsubmit.php" method="post">
			<input type="text" name="DBId" class="secretVal" value="<?php echo $randomID; ?>">
			<table>
				<tr>
					<td>Full Name</td>
